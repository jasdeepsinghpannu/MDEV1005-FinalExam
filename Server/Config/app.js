...
const famous_people_1 = __importDefault(require("../Routes/famous-people"));
...
app.use('/api/famousPeople', passport_1.default.authenticate('jwt', { session: false }), famous_people_1.default);
